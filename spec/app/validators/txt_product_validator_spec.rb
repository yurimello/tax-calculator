  ...
  describe '.validate' do
    context 'with valid product lines' do
      it 'validates basic product line' do
        ...
        expect(described_class.validate(product_line)).to be_truthy
      end
    ...
    context 'with invalid product lines' do
      it 'rejects empty string' do
        ...
        expect(described_class.validate(product_line)).to be_falsey
      end
      ...
      it 'handles nil input without crashing' do
        ...
        expect { described_class.validate(product_line) }.to raise_error(NoMethodError)
      end
    end
